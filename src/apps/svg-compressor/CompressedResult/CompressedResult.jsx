...
export default function CompressedResult({ content, fileKey }) {
  ...
  const convertToJsx = () => {
    localStorage.setItem('@mayavi/conversion-after-compression/jsx', JSON.stringify(content));
    history.push('/svg-to-jsx');
  };

  const convertToB64 = () => {
    localStorage.setItem('@mayavi/conversion-after-compression/b64', JSON.stringify(content));

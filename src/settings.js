module.exports = {
  repository: 'https://github.com/aanwik/mayavi',
  bugs: 'https://github.com/aanwik/mayavi/issues/new',

  meta: [
    { internal: true, to: '/about', label: 'About' },
    {
      href: 'https://github.com/aanwik/mayavi/issues/new',
      label: 'Report issue',
    },
    {
      href: 'https://github.com/aanwik/mayavi/blob/master/CONTRIBUTING.md',
      label: 'Contribute',
    },
    {
      href: 'https://github.com/aanwik/mayavi/blob/master/CHANGELOG.md',
      label: 'Changelog',
    },
  ],
  ...
  maintainers: {
    author: {
      ...
      tg: 'aanwik',
      github: 'aanwik',
      website: 'https://github.com/aanwik',
    },
